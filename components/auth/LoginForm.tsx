      ...
      <form onSubmit={submit} className="w-full max-w-[360px] animate-fade-in">
        ...
        <label className="block text-[12px] font-medium text-ink-2">
          ...
          <input
            ...
            className="mt-1 h-11 w-full rounded-lg border border-line bg-transparent px-3 text-[13px] outline-none focus:ring-2 focus:ring-[#2563EB]/30"
          />
        </label>
        <label className="mt-3 block text-[12px] font-medium text-ink-2">
          ...
          <span className="relative mt-1 block">
            <input
              ...
              className="h-11 w-full rounded-lg border border-line bg-transparent px-3 pr-10 text-[13px] outline-none focus:ring-2 focus:ring-[#2563EB]/30"
            />
            <button
              type="button"
              className="absolute right-1 top-1/2 -translate-y-1/2 rounded-md p-2 text-ink-3 hover:bg-black/5"
        ...
        <button
          type="submit"
          disabled={busy}
          className="mt-5 flex h-11 w-full items-center justify-center gap-2 rounded-lg bg-[#2563EB] text-[14px] font-medium text-white hover:bg-[#1d4ed8] disabled:opacity-60"
        >
